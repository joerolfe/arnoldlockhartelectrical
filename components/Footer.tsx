        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 pb-10 border-b border-white/5">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3.5 mb-5">
              ...
              <li>
                <a href="mailto:contact@alhelectrical.co.uk" className="flex items-center gap-2.5 text-gray-400 hover:text-red-500 text-sm transition-colors">
                  <svg className="w-4 h-4 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  contact@alhelectrical.co.uk
                </a>
              </li>
              <li>
